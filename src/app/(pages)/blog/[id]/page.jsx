                    ...
                    <li>
                        ...
                        <span>
                            {postData.categories.map((item, key) => (
                                <span>
                                    <Link key={`post-tag-item-${key}`} href={`/blog/category/${item.toLowerCase().replace(' ', '-')}`}>{item}</Link>
                    ...
                    <li>
                        ...
                        <span>
                            {postData.tags.map((item, key) => (
                                <span>
                                    <Link key={`post-tag-item-${key}`} href={`/blog/tag/${item.toLowerCase().replace(' ', '-')}`}>{item}</Link>
